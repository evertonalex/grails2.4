<%@ page import="primeiroapp.Cotacao" %>
...
<div class="fieldcontain ${hasErrors(bean: cotacaoInstance, field: 'fornecedor', 'error')} required">
	...
	<g:select id="fornecedor" name="fornecedor.id" from="${primeiroapp.Fornecedor.list()}" optionKey="id" required="" value="${cotacaoInstance?.fornecedor?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: cotacaoInstance, field: 'item', 'error')} required">
	...
	<g:select id="item" name="item.id" from="${primeiroapp.Item.list()}" optionKey="id" required="" value="${cotacaoInstance?.item?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: cotacaoInstance, field: 'moeda', 'error')} required">
	...
	<g:select id="moeda" name="moeda.id" from="${primeiroapp.Moeda.list()}" optionKey="id" required="" value="${cotacaoInstance?.moeda?.id}" class="many-to-one"/>
